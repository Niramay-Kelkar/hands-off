...
This system was implemented against one concrete surface — a legacy-style web application — and this section is design, not a claim of what was built; a second surface or a second tenant variant was deliberately not built, consistent with the brief's own note that neither is expected.
